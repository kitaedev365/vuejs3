...
public class ProductController {
    ...
    public ResponseEntity<Product> getProduct(@PathVariable("pno") int pno) {
    ...
    public ResponseEntity<String> deleteProduct(@PathVariable("pno") int pno) throws IOException {
