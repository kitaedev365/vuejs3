...
public class ProductController {
    ...
    public ResponseEntity<Product> getProductById(@PathVariable(name ="pno") int id) {
    ...
    public ResponseEntity<Product> updateProduct(@PathVariable(name = "pno") int id,
    ...
    public ResponseEntity<Void> deleteProduct(@PathVariable(name = "pno") int id) {
        deleteFiles(productService.getProductById(id).orElseThrow().getImg1(), productService.getProductById(id).orElseThrow().getImg2(), productService.getProductById(id).orElseThrow().getImg3());
